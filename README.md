...
//    }
    ...
    public void testAssertTitle()
    {
        ...
        waitForElementAndClick(
                By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_title'][@text='IPhone']"),
...
//                By.xpath(search_result_locator),
//                "We've found found some results by request " + search_line
//        );
//    }
//
//    @Test
...
//
    ...
    private WebElement assertElementHasTitle(By by, String expected_text, String error_message){
    ...
    protected void  assertElementPresent(By by, String error_message, int max_element)
    {
...
//            ++already_present;
    ...
    private void openWiki(String search_string, String expected_string)
    {
